      ...
      <Col>
        <Card>
          <table class="table">
            <tbody>
              <tr>
                <td class="col-lg-1 normal text-center">
                  <strong>標示說明:</strong>
                </td>
                <td class="col-lg-1 over_internal_std text-center">
                  <i class="fa fa-exclamation-triangle"></i>超過內控值
                </td>
                <td class="col-lg-1 over_law_std text-center">
                  <i class="fa fa-exclamation-triangle"></i>超過法規值
                </td>
